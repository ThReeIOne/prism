...
const (
	CollectorService_Report_FullMethodName = "/prism.CollectorService/Report"
)
...
type CollectorServiceClient interface {
	Report(ctx context.Context, in *SpanBatch, opts ...grpc.CallOption) (*ReportResponse, error)
}
...
func (c *collectorServiceClient) Report(ctx context.Context, in *SpanBatch, opts ...grpc.CallOption) (*ReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportResponse)
	err := c.cc.Invoke(ctx, CollectorService_Report_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollectorServiceServer interface {
	Report(context.Context, *SpanBatch) (*ReportResponse, error)
...
func (UnimplementedCollectorServiceServer) Report(context.Context, *SpanBatch) (*ReportResponse, error) {
...
func _CollectorService_Report_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).Report(ctx, req.(*SpanBatch))
	}
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "prism.CollectorService",
